...
const ProductDetailCard=({product,onAddProduct})=>{
    ...
    <div className="flex flex-col items-center justify-between">
        <h2 className="text-3xl flex text-black">{product.name}</h2>
    ...
    <div className="w-full flex items-center justify-center bg-marigold">
        <Button variant="dark" onClick={onAddProduct}>Add to Cart</Button>
    </div>
    </div>
        )
}
