...
//                 <label
//                 htmlFor="name"
//                 className="block yext-lg font-medium text-gray-200"
//                 >Name</label>
//                 <input
//                 {...register('name')}
//                 id="name"
//                 type="text"
//                 className="bloack apperance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-gray-200 focus:border-gray-200"
//                 />
